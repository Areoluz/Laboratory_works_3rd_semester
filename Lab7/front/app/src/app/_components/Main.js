...
function Main() {
    ...
    const deleteFunction = async (hash) => {
        try {
            ...
            setFunctions((prevFunctions) => prevFunctions.filter((func) => func.hash !== hash));
                ...
                <div className='flex flex-col gap-6'>
                    <div className="bg-base-100 dark:bg-base-700 p-6 rounded-lg shadow-md">
                        ...
                        <div className="overflow-x-auto">
                            ...
                            <div>
                                {functions.map((func, index) => (<div key={func.hash}>
                                    <div className="flex w-full mb-2 text-base-content">
            ...
            >
                ...
                >
                    ...
                    <div className="text-base-content">
                        {modalData.points.map((point, idx) => (<p key={idx}>
